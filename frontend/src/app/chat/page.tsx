...
export default function ChatPage() {
  ...
  return (
    <div className="flex flex-col h-full relative bg-background overflow-hidden">
      ...
      {/* Header */}
      <div className="shrink-0 p-4 pt-20 md:p-6 md:pt-6 border-b border-border/50 bg-card/60 backdrop-blur-xl sticky top-0 z-20 shadow-sm transition-all duration-300 flex flex-col gap-2 md:gap-3 items-center md:items-start justify-center min-h-[5rem] text-center md:text-left">
